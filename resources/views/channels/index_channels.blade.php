...
<div class="uk-section uk-section-muted" style="background-color:#001628;">
    <div class="uk-container">
        <h1 class="uk-heading-line uk-text-center"><span class="headfonts">Youtube Channels</span></h1>
    </div>
</div>
...
<div class="uk-card uk-card-default uk-card-body uk-width-1-2@lg">
    ...
    <form action="{{route('search.channel')}}" method="POST" role="search">
    ...
    <!-- Add Font -->
    <a class="uk-badge uk-margin-small-right uk-flex-right" href="{{route('create.channel')}}">
        ...
        <tbody>
            ...
            @foreach($channels as $channel)
                <tr>
                    ...
                    <td>{{$channel->link}}</td>
                    <td>
                        <a class="uk-button uk-button-primary" href="{{route('edit.channel',['id'=>$channel->id])}}"><i class="fas fa-edit"></i> Edit</a>
                    </td>
                    <td>
                        <a class="uk-button uk-button-danger" href="{{route('delete.channel',['id'=>$channel->id])}}"><i class="fas fa-trash-alt"></i> Delete</a>
                    </td>
                </tr>
            @endforeach
