...
<div class="uk-card uk-card-default uk-card-body uk-width-1-2@lg">
    ...
    <form action="{{route('search.color')}}" method="POST" role="search">
    ...
    <!-- Add Color -->
    <a class="uk-badge uk-margin-small-right uk-flex-right" href="{{route('create.color')}}">
        ...
        <tbody>
            ...
            @foreach($colors as $color)
                <tr>
                    ...
                    <td>{{$color->link}}</td>
                    <td>
                        <a class="uk-button uk-button-primary" href="{{route('edit.color',['id'=>$color->id])}}"><i class="fas fa-edit"></i> Edit</a>
                    </td>
                    <td>
                        <a class="uk-button uk-button-danger" href="{{route('delete.color',['id'=>$color->id])}}"><i class="fas fa-trash-alt"></i> Delete</a>
                    </td>
                </tr>
            @endforeach
