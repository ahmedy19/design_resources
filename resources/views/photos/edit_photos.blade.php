...
<div class="uk-card uk-card-default uk-grid-collapse uk-child-width-1-2@s uk-margin" uk-grid>
    ...
    <div>
        <div class="uk-card-body">
            <h3 class="uk-card-title">Edit Photos</h3>

                <form action="{{route('update.photo',['id'=>$photos->id])}}" method="POST">
                    ...
                    <fieldset class="uk-fieldset">
                        ...
                        <div class="uk-margin">
                            <input class="uk-input" name="name" type="text" placeholder="Website name" value="{{$photos->name}}">
                        </div>

                        <div class="uk-margin">
                            <input class="uk-input" name="link" type="text" placeholder="Website Link" value="{{$photos->link}}">
                        </div>
